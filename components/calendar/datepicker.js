...
var DatePicker = React.createClass({
    ...
    render: function() {
        ...
        return <div className={className} onKeyDown={this.onKeyDown}>
            {clear}
            <i className="fa fa-calendar" onClick={this.handleFocus}></i>
            <DateInput
                ref="dateInput"
            ...
            { maybe(this.state.focus,
                <Popover className="popover-calendar-container"
                         onClose={this.hideCalendar}>
                    <div className="datepicker-triangle"></div>
                    <Calendar
                        numCalendars={1}
